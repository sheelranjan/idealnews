...
export default class News extends Component {
  ...
  async componentDidMount(){
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}${this.props.category}&apiKey=f6838838ba4f4d76ab104be2063a6e70&page=1&pageSize=${this.props.pageSize}`;
